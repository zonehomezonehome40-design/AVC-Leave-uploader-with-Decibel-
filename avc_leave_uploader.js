(async()=>{
    ...
    document.getElementById('ex').onclick=async()=>{
        let t = await waitFor("table") || await waitFor("table#desiredTableId");
    ...
    document.getElementById("up").onchange=async e=>{
        ...
        let search = await waitFor("input.form-control.form-control-sm[type='search']") || await waitFor("input[type='search']");
